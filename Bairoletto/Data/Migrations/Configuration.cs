    ...
    internal sealed class Configuration : DbMigrationsConfiguration<Data.DataContext>
    {
        ...
        protected override void Seed(Data.DataContext context)
        {
            ...
            context.Productos.AddOrUpdate(new Producto[] {
                ...
                new Producto { Id = 6, TipoProducto = TipoProducto.comestible, Codigo = "COM_EMP_006", Nombre = "Empanada jamón y queso", Stock=1235,PrecioCosto = 8.50, Descripcion = "Jamón cocido, mozzarella" },
                new Producto { Id = 7, TipoProducto = TipoProducto.comestible, Codigo = "COM_PIZ_001", Nombre = "Pizza muzzarella con jamón", Stock=620,PrecioCosto = 23.60, Descripcion = "Mozzarella, jamón cocido, aceitunas verdes" },
